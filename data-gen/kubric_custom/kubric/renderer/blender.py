...
class Blender(core.View):
    ...
    def __init__(self,
        ...
        # self.png_output_node = blender_utils.add_png_output_node(str(self.scratch_dir / "images"))
    ...
    def _setup_scene_shading(self):
        ...
        links.new(self.bg_mapping_node.outputs.get("Vector"),
